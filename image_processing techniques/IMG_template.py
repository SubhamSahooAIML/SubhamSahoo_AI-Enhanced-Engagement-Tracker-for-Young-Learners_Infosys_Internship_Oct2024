...
img = cv2.imread("C:\\Users\\Acer\\OneDrive\\Desktop\\guns\\41.jpeg", cv2.IMREAD_GRAYSCALE)
# Load the template image in grayscale
template = cv2.imread("C:\\Users\\Acer\\OneDrive\\Desktop\\guns\\41.jpeg", cv2.IMREAD_GRAYSCALE)
