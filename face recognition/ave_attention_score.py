...
if not os.path.exists("C:\\Users\Acer\\OneDrive\\Desktop\\attention_score\\screenshots_avg_attention/-score"):
    os.makedirs("C:\\Users\Acer\\OneDrive\\Desktop\\attention_score\\screenshots_avg_attention/-score")

# Load the known image of subham_sahoo_
...
try:
    while True:
        ...
        frame = cv.resize(frame, (480, 360))  # Downscale for faster processing
        ...
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            ...
            if distance < 0.6:
                ...
                screenshot_filename = f"C:\\Users\Acer\\OneDrive\\Desktop\\attention_score\\screenshots_avg_attention-score/{name}_{now.strftime('%Y-%m-%d_%H-%M-%S')}.jpg"
                if attentive == 'Yes':
        ...
        # Display the frame
        cv.imshow("Video Stream for avg_attention", frame)
    ...
    if not df.empty:
        ...
        df.to_excel('C:\\Users\Acer\\OneDrive\\Desktop\\attention_score\\attendance_with_attention_and_average.xlsx', index=False)
