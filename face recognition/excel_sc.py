...
screenshot_dir = "C:\\Users\\Acer\\OneDrive\\Desktop\\attention_score\\screenshots_excel_sc.py"
...
try:
    while True:
        ...
        cv.imshow('Video Stream for excel_sc', frame)
    ...
    if not df.empty:
        df.to_excel('C:\\Users\Acer\\OneDrive\\Desktop\\attention_score\\attendance_screenshot_excel_sc.py.xlsx', index=False)
        print("Attendance and screenshots saved to attendance_screenshot_excel_sc.py.xlsx.")
