...
if not os.path.exists("C:\\Users\Acer\\OneDrive\\Desktop\\attention_score\\screenshots_attention_score"):
    os.makedirs("C:\\Users\Acer\\OneDrive\\Desktop\\attention_score\\screenshots_attention_score")
...
try:
    while True:
        ...
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            ...
            if distance < 0.6:
                ...
                screenshot_filename = f"C:\\Users\Acer\\OneDrive\\Desktop\\attention_score\\screenshots_attention_score/{name}_{now.strftime('%Y-%m-%d_%H-%M-%S')}.jpg"
                if attentive == 'Yes':
        ...
        # Display the frame
        cv.imshow("Video Stream for attention score ", frame)
    ...
    if not df.empty:
        df.to_excel('C:\\Users\Acer\\OneDrive\\Desktop\\attention_score\\attendance_attention_score.xlsx', index=False)
